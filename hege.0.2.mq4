...
extern string Symbs = "EURUSD|USDJPY|EURJPY";
...
void OnTimer(){
   ...
   getPrices();
   double v = price[1]*price[3] - price[4];//sell sell buy  
   double k = price[0]*price[2] - price[5];//buy buy sell 
